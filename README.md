...
Skybase is a fork of graphik, we added the use of CRDT replication similar to Riak and OrbitDB to allow for scaling this database to meet the needs of the masses.
